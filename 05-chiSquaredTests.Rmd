...
tableplot(Arthritis,select=c(Treatment,Improved,Sex,Age), pals=list("BrBG"), sample=F,  colorNA_num = "orange", numMode = "MB-ML")
```
...
```{r Figure5-4,fig.cap="(ref:fig5-4)",echo=F, fig.height=5.5}
...
```{r Figure5-8,fig.cap="(ref:fig5-8)",echo=F,fig.width=7,fig.height=7}
set.seed(98765)
Arthperm$PermTreatment <- factor(shuffle(Arthperm$Treatment))
par(mfrow=c(2,2))
...
```{r Figure5-11,fig.cap="(ref:fig5-11)",echo=F,message=F,warning=F,fig.width=10,fig.height=6}
plot(Improved~Treatment, data=Arthritis,
     main="Stacked Bar Chart of Arthritis Data")
```
...
tableplot(election2, select=c(VOTEF,PARTY,EDUC,GENDER), sort=1, pals=list("BrBG"), sample=F)
```
...
```{r Figure5-25,fig.cap="(ref:fig5-25)",echo=F, fig.height=5.5}
old.par <- par(mai=c(0.5,0.5,0.5,0.5))
