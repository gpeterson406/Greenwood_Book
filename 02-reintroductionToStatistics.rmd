...
```{r Figure2-6, fig.cap="(ref:fig2-6)",echo=F}
par(mfrow=c(1,2))
#old.par <- par(mai=c(0.5,0.5,0.5,0.5))
...
```{r Figure2-8, fig.cap="(ref:fig2-8)",echo=F, fig.pos="t"}
par(mfrow=c(1,2))
...
```{r Figure2-11, fig.cap="(ref:fig2-11)",echo=F,cache=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", 
                 center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, 
...
```{r Figure2-13, fig.cap="(ref:fig2-13)",echo=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", 
                 center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, 
...
```{r Figure2-16, fig.cap="(ref:fig2-16)",echo=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", 
                 center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, 
...
```{r Figure2-19, fig.cap="(ref:fig2-19)",echo=F,cache=F}
set.seed(123456)
...
```{r Figure2-20, fig.cap="(ref:fig2-20)",echo=T,cache=T}
...
```{r Figure2-22, fig.cap="(ref:fig2-22)",echo=T,cache=T}
# Simulation study of generating 10 data sets and either using the first 
# or "best p-value" result:
set.seed(1234)
...
```{r Figure2-25, fig.cap="(ref:fig2-25)",echo=F,cache=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", 
                 center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, 
...
```{r Figure2-27,fig.cap="(ref:fig2-27)",echo=F,cache=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
