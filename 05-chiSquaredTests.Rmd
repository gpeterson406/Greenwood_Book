...
```{r Figure5-2,fig.cap="(ref:fig5-2)",fig.width=11,fig.height=6}
...
```{r Figure5-3,fig.cap="(ref:fig5-3)",echo=F,out.width="100%",fig.align="center"}
...
```{r Figure5-4,fig.cap="(ref:fig5-4)",echo=F,fig.width=11,fig.height=6}
...
```{r Figure5-5,fig.cap="(ref:fig5-5)",fig.width=11,fig.height=6}
...
```{r Figure5-6,fig.cap="(ref:fig5-6)",echo=F,fig.width=11,fig.height=6}
...
```{r Figure5-7,fig.cap="(ref:fig5-7)",echo=F,fig.width=11,fig.height=6}
ArthritisFAKE <- rbind(Arthritis,Arthritis) # Just to make the following plot!
ArthritisFAKE$Treat <- factor(c(rep("Placebo",84),rep("Treated",84))) #Just to make the following plot
par(las=2)
plot(Improved~Treat,data=ArthritisFAKE,main="Homogeneity Null Hypothesis True")
...
```{r Figure5-8,fig.cap="(ref:fig5-8)",echo=F,fig.width=11,fig.height=11}
set.seed(98765)
Arthperm <- Arthritis
Arthperm$PermTreatment <- factor(shuffle(Arthperm$Treatment))
par(mfrow=c(2,2))
old.par <- par(mai=c(0.5,0.75,0.5,0.5), las=2)
...
```{r Figure5-11,fig.cap="(ref:fig5-11)",echo=F,message=F,warning=F,fig.width=11,fig.height=6}
par(las=2)
plot(Improved ~ Treatment, data = Arthritis,
     main = "Stacked Bar Chart of Arthritis Data")
```
...
```{r Figure5-12,fig.cap="(ref:fig5-12)",echo=F,fig.height=5,fig.width=10}
...
3. **Calculate the test statistic and p-value:**
    ...
    * The parametric p-value is < 2.2e-16 from the R output which 
    ...
    ```{r Figure5-15,fig.cap="Plot of $\\boldsymbol{\\chi^2}$-distribution with 12 degrees of freedom.",echo=F,fig.height=2.75,fig.width=3.7}
    ...
    * But since the expected cell count condition is violated, we should 
    ...
    ```{r Figure5-16,fig.cap="Permutation distribution of $X^2$ for the election data. Observed value of 763 not displayed.", fig.width=6, warning=F}
...
```{r Figure5-18,fig.cap="(ref:fig5-18)", fig.height=5,fig.width=10}
library(poLCA)
...
```{r Figure5-19,fig.cap="(ref:fig5-19)",fig.height=5,fig.width=10,echo=F}
...
```{r Figure5-25,fig.cap="(ref:fig5-25)",echo=F,fig.width=11,fig.height=6}
old.par <- par(mai=c(0.5,1.5,0.5,0.5), las=2)
...
```{r Figure5-27,fig.cap="(ref:fig5-27)",echo=F,fig.width=10,fig.height=5}
library(tabplot)
...
```{r Figure5-28,fig.cap="(ref:fig5-28)",echo=F, fig.width=8}
dd <- dd %>%  mutate(
