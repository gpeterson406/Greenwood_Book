...
```{r Figure1-1, echo=FALSE, fig.cap ="(ref:fig1-1)",fig.align="center"}
...
```{r Figure1-8, fig.cap="(ref:fig1-8)",echo=F, out.width="50%"}
old.par <- par(mai=c(0.5,0.5,0.5,0.5))
...
\index As opposed to base graphics, the ggplots will contain multiple components 
...
```{r Figure1-10, fig.cap="(ref:fig1-10)",echo=F}
library(ggplot2)
...
\index The following chapters will explore further modifications for these 
