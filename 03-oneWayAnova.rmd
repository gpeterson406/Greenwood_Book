...
$$\boldsymbol{H_A:} \textbf{ Not all } \boldsymbol{\tau_j} \textbf{ equal } \bf{0} \textbf{, for j = 2, ..., J.}$$
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
$H_A: \color{purple}{\text{ Not all } \tau_j \text{ equal 0, for j = 2, ..., J} }$
...
```{r Figure3-11,fig.cap="(ref:fig3-11)",echo=T}
...
* **Tobs ``<-`` anova(lm(`r colFmt("Y","red")` ~ `r colFmt("X","red")`, data = `r colFmt("DATASETNAME","red")`))[1,4]; Tobs  
    ...
    Tstar ``<-`` matrix(NA, nrow = B)  
    for (b in (1:B)){  
      Tstar[b] ``<-`` anova(lm(`r colFmt("Y","red")` ~ shuffle(`r (colFmt("X","red"))`), data = `r colFmt("DATASETNAME","red")`))[1,4]  
    }  
    pdata(Tstar, Tobs, lower.tail = F)[[1]]**  
