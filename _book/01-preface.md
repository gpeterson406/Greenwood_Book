...
\begin{figure}[ht]
\includegraphics[width=18.36in]{chapter1_files/image002} \caption{(ref:fig1-1)}(\#fig:Figure1-1)
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=13.67in]{chapter1_files/fig1.2} \caption{(ref:fig1-2)}(\#fig:Figure1-2)
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=13.44in]{chapter1_files/fig1.3} \caption{(ref:fig1-3)}(\#fig:Figure1-3)
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=1\linewidth]{chapter1_files/fig1.4} \caption{(ref:fig1-4)}(\#fig:Figure1-4)
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=1\linewidth]{chapter1_files/image010} \caption{(ref:fig1-6)}(\#fig:Figure1-6)
\end{figure}
