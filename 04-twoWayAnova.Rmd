...
```{r Figure4-9,fig.cap="(ref:fig4-9)",echo=F,fig.height=4,fig.width=6}
data(ToothGrowth)
require(tibble)
...
\index{validity conditions!Two-Way ANOVA}
    ...
    * Constant variance:
        ...
        * In the Residuals vs Fitted and the Scale-Location plots, the 
        ...
        ```{r Figure4-10,fig.cap="Diagnostic plots for the interaction model for odontoblast         growth interaction model.",fig.height=5,fig.width=10}
        par(mfrow=c(2,2))
        plot(TG2, pch=16) 
        ```
...
```{r Figure4-11,fig.cap="(ref:fig4-11)",echo=F}
...
```{r Figure4-12,fig.cap="(ref:fig4-12)",echo=F,fig.height=5,fig.width=10}
par(mfrow=c(1,1))
...
```{r Figure4-13,fig.cap="(ref:fig4-13)",fig.height=5,fig.width=10}
...
```{r Figure4-14,fig.cap="(ref:fig4-14)",fig.height=5,fig.width=10}
par(mfrow=c(2,2))
plot(debt1)
```
...
\index{validity conditions!Two-Way ANOVA}
    ...
    ```{r Figure4-15,fig.cap="Diagnostic plot for ``prodebt`` by income group and buy   cigarettes/not",fig.height=5,fig.width=10}
...
```{r Figure4-17,fig.cap="(ref:fig4-17)",echo=F,fig.width=6,fig.height=3.5}
par(mfrow=c(1,2))
old.par <- par(mai=c(0.85,1,0.5,0.25))
debt1r_fitted_jitter <- jitter(fitted(debt1r))
intplot(debt1r_fitted_jitter~cigbuy*incomegp,data=debtc,col=c(1,3),
        lwd=2,main="(a)",ylab="Mean of ProDebt",xlim=c(0.8,7),cex.leg=0.75)
debt1r_fitted_jitter <- jitter(fitted(debt1r))
intplot(debt1r_fitted_jitter~incomegp*cigbuy,data=debtc,lwd=2,
...
```{r Figure4-18,fig.cap="(ref:fig4-18)",echo=F,fig.height=2.75}
par(mfrow=c(1,1))
...
```{r Figure4-19,fig.cap="(ref:fig4-19)",fig.height=3}
