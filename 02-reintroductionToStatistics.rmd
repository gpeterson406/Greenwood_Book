...
```{r Figure2-7, echo=FALSE, fig.cap ="(ref:fig2-7)",fig.width=6,cache=T}
...
```{r Figure2-15, fig.cap="(ref:fig2-15)",echo=F,fig.width=10,fig.height=5}
par(mfrow=c(1,2))
hist(Tstar, labels=T,ylim=c(0,250))
abline(v=c(-1,1)*Tobs, lwd=2, col="red")
plot(density(Tstar), main="Density curve of Tstar")
...
```{r Figure2-17, fig.cap="(ref:fig2-17)",echo=F,fig.width=10,fig.height=5,cache=F}
par(mfrow=c(1,2))
...
```{r Figure2-19, fig.cap="(ref:fig2-19)",echo=F,fig.width=10,fig.height=5,cache=T}
...
```{r Figure2-21, fig.cap="(ref:fig2-21)",echo=F,fig.width=5,fig.height=5,cache=T}
...
```{r Figure2-22, fig.cap="(ref:fig2-2)",echo=F,cache=T}
...
```{r Figure2-23, fig.cap="(ref:fig2-23)",echo=F,fig.width=10,fig.height=5,cache=F}
par(mfrow=c(1,2))
...
```{r Figure2-26,fig.cap="(ref:fig2-26)",echo=F,fig.width=10,fig.height=5,cache=F}
par(mfrow=c(1,2))
hist(Tstar,labels=T,ylim=c(0,250))
abline(v=Tobs,col="red",lwd=2)
