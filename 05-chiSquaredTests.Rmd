...
# Required options to avoid error when running on a PC, should have no impact on other platforms
options(ffbatchbytes = 1024^2 * 128); options(ffmaxbytes = 1024^2 * 128 * 32) 
...
### Determine type of Chi-Square test
...
### Overtake close calls by outfit analysis
