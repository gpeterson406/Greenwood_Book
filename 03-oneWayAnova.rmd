...
```{r Figure3-1,fig.cap="(ref:fig3-1)",echo=F}
library(mosaic)
library(readr)
library(yarrr)
...
```{r Figure3-2, fig.cap="(ref:fig3-2)"}
library(effects)
plot(allEffects(lm2))
```
...
```{r Figure3-3, fig.cap="(ref:fig3-3)", echo=F, fig.height=9}
set.seed(98876)
e1 <- rnorm(40)
x1 <- rep(c("A","B","C","D"),10)
...
```{r Figure3-4, fig.cap="(ref:fig3-4)",echo=F, fig.height=9}
...
```{r Figure3-5,fig.cap="(ref:fig3-5)",echo=F}
set.seed(123)
B <- 1000
...
```{r Figure3-8,fig.cap="(ref:fig3-8)",echo=F}
par(mfrow = c(1,1))
...
```{r Figure3-11,fig.cap="(ref:fig3-11)",echo=F}
...
```{r Figure3-12,fig.cap="(ref:fig3-12)",echo=F, fig.height=12, out.width="100%"}
...
```{r Figure3-13,fig.cap="(ref:fig3-13)",echo=F}
#One normal example
y5 <- scale(rnorm(75))
...
\index{validity conditions!One-Way ANOVA}
    ...
    * Constant variance:
        ...
        * There is some indication of a difference in the 
        ...
        ```{r Figure3-15,fig.cap="Diagnostic plots for the odontoblast growth model."}
...
```{r Figure3-17, fig.cap="(ref:fig3-17)",echo=F}
par(mfrow = c(1,1))
...
```{r Figure3-18, fig.cap="(ref:fig3-18)"}
library(multcomp)
...
```{r Figure3-19, fig.cap="(ref:fig3-19)",echo=T}
...
```{r Figure3-20,fig.cap="(ref:fig3-20)",echo=F}
