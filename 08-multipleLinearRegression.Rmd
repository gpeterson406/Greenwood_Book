...
```{r Figure8-14,fig.cap="(ref:fig8-14)",echo=T,fig.width=8,fig.height=6}
...
```{r Figure8-40,fig.cap="(ref:fig8-40)",echo=F,warning=F,message=F,out.width="100%",fig.align="center"}
