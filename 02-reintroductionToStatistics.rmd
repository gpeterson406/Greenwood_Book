...
```{r Figure2-16, fig.cap="(ref:fig2-16)",echo=F,fig.width=5,fig.height=5}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, geom = "text") + 
  geom_density(aes(y = ..scaled..)) + theme_bw() + labs(y = "Density") +
...
```{r Figure2-18, fig.cap="(ref:fig2-18)",echo=F,fig.width=5,fig.height=5,cache=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
  geom_histogram(aes(y = ..ncount..), bins = 15, col = 1, fill = "skyblue", center = 0) +
  stat_bin(aes(y = ..ncount.., label = ..count..), bins = 15, geom = "text") + 
  geom_density(aes(y = ..scaled..)) + theme_bw() + labs(y = "Density") +
...
```{r Figure2-27,fig.cap="(ref:fig2-27)",echo=F,fig.width=5,fig.height=5,cache=F}
tibble(Tstar) %>%  ggplot(aes(x = Tstar)) + 
