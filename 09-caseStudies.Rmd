...
```{r Figure9-1,fig.cap="(ref:fig9-1)",echo=F,out.width="100%",fig.align="center"}
...
library(yarrr)
pirateplot(Massperha~Species+Treatment, data=gdn, inf.method="ci", inf.disp="line", theme=2,
           ylab="Biomass", point.o=1, pal="southpark")
```
...
par(mfrow=c(2,1))
pirateplot(logMassperha~Species+Treatment, data=gdn, inf.method="ci", inf.disp="line", theme=2,
           ylab="Biomass",point.o=1, pal="southpark", main="(a)")
