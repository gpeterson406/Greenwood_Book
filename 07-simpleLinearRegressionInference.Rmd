...
```{r Figure7-9,fig.cap="(ref:fig7-9)",fig.height=5,fig.width=5}
B <- 1000
...
library(carData)
data(UN)
UN <- as_tibble(carData::UN) %>% drop_na(infantMortality, ppgdp) #Needed to find the correct UN data set from car and remove any rows missing on variables of interest
par(mfrow=c(2,2))
