...
using a ***Chi-square test*** for a categorical response. \index{Chi-squared test} After selecting the
...
***interaction*** between the two explanatory variables: \index{interaction!2-way ANOVA} the relationship between one categorical
...
> `Readr` is not the same as `readr`
>
...
of code and hit the "Run" button^[You can also use Ctrl-R if you like hot keys.] 
