...
```{r Figure6-14,fig.cap="(ref:fig6-14)",echo=F,warning=F,message=F,out.width="100%"}
...
```{r Figure6-17,fig.cap="(ref:fig6-17)",echo=F,warning=F,message=F,out.width="100%"}
...
6.1. These questions revisit the treadmill data set from Chapter \@ref(chapter1).
Researchers were
