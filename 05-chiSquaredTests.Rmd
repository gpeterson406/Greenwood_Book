...
```{r Figure5-11,fig.cap="(ref:fig5-11)",echo=F,message=F,warning=F,fig.width=10,fig.height=5.5}
plot(Improved~Treatment, data=Arthritis,
     main="Stacked Bar Chart of Arthritis Data")
```
...
pirateplot(growth~stype, data=apistrat, inf.method="ci", inf.disp="line", pal="southpark")
```
...
```{r eval=F}
pirateplot(growth~stype, data=apistratinf.method="ci", inf.disp="line")
```
