...
quantitative variables^[They hold factor variables at their modal category but we don't have factor variables in the MLR models, yet.] at their mean and generating predictions and 95% CIs for the mean
...
* **Be cautious about doing prediction in MLR -- you might be doing extrapolation!**
    ...
    of 30. Is this extrapolation based on Figure \@ref(fig:Figure8-13)? In other
    ...
    \@ref(fig:Figure8-13) also reinforces our potential collinearity problem
    between *Elevation* and *Max.Temp* with higher elevations being strongly
    associated with lower temperatures. 

    <div class="figure">
    <img src="08-multipleLinearRegression_files/figure-html/Figure8-13-1.png" alt="Scatterplot of observed Elevations and Maximum Temperatures for SNOTEL data." width="480" />
    <p class="caption">(\#fig:Figure8-13)Scatterplot of observed Elevations and Maximum Temperatures for SNOTEL data.</p>
    </div>
...
* **Multicollinearity in MLR models:**
    ...
    <div class="figure">
    <img src="08-multipleLinearRegression_files/figure-html/Figure8-14-1.png" alt="Plot of correlation matrix in the snow depth data set with influential points removed" width="624" />
    <p class="caption">(\#fig:Figure8-14)Plot of correlation matrix in the snow depth data set with influential points removed</p>
    </div>
...
*Elevation*, so we can conclude that there is a linear relationship between them given *Elevation* in the population of SNOTEL sites in Montana on this day. Because
...
(ref:fig8-15) Scatterplot matrix of SAT and GPA data set.
...
<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-15-1.png" alt="(ref:fig8-15)" width="960" />
<p class="caption">(\#fig:Figure8-15)(ref:fig8-15)</p>
</div>

There are positive relationships in Figure \@ref(fig:Figure8-15) among all the
...
(ref:fig8-16) Diagnostic plots for the $\text{FYGPA}\sim\text{ SATV }+\text{ SATM}$ model.
...
2. Plot the data and assess validity conditions:
    ...
    * **Linearity of relationships:**
        ...
        * The initial scatterplots (Figure \@ref(fig:Figure8-15)) do not show 
        any clear nonlinearities with each predictor used in this model.
        
        * The Residuals vs Fitted and Scale-Location plots (Figure 
        \@ref(fig:Figure8-16)) do not show much more than a football shape,
        which is our desired result.
        
        * The partial residuals are displayed in Figure \@ref(fig:Figure8-17) and do not suggest any clear missed curvature.
...
how much change this implies over the range of observed predictor values. 
    ...
    * The term-plots (Figure \@ref(fig:Figure8-17)) provide a visualization of the "size" of the differences in the response variable explained by each predictor. \index{effects plot} The *SATV* term-plot shows that for the range of percentiles from around the
...
(ref:fig8-17) Term-plots for the $\text{FYGPA}\sim\text{SATV} + \text{SATM}$ model with partial residuals.
...
Figure \@ref(fig:Figure8-18) remakes
...
(ref:fig8-18) Term-plots for the $\text{FYGPA}\sim\text{SATV} + \text{SATM}$ model with 95% confidence intervals (red, dashed lines) and 95% PIs (light grey, dotted lines). 
...
the scatterplot of *FYGPA* vs *SATV* (Figure \@ref(fig:Figure8-19)) and
...
\indent The results for *SATV* contrast with Figure \@ref(fig:Figure8-20) for the relationship
...
(ref:fig8-19) Plot of FYGPA vs SATV by Sex of students.
...
(ref:fig8-20) Plot of FYGPA vs SATM by Sex of students.

<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-20-1.png" alt="(ref:fig8-20)" width="960" />
...
\indent To make this visually clearer, Figure \@ref(fig:Figure8-21) contains the
...
Figure \@ref(fig:Figure8-20). 

(ref:fig8-21) Plot of estimated model for *FYGPA* vs *SATM* by *GENDER* of students (female line is thicker dark line). Dashed lines aid in seeing the consistent vertical difference of 0.313 in the two estimated lines based on the model containing a different intercept for each group.

<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-21-1.png" alt="(ref:fig8-21)" width="576" />
...
different $y$-intercepts in the two groups. In Figure \@ref(fig:Figure8-22), the
...
frequently occurring value (modal category) in the data set, which is for males in this data set. 

(ref:fig8-22) Term-plots for the estimated model for $\text{FYGPA}\sim\text{SATM} + \text{GENDER}$.
...
$y$-intercept in a *SATM* model for first year college GPA between *males* and *females*, so we would conclude that there is difference in their true mean GPA levels controlled for *SATM*. The confidence
...
of the results in Figure \@ref(fig:Figure8-23) shows some variation in the
...
(ref:fig8-23) Scatterplot of post-treatment decibel tolerance (du2) vs pre-treatment tolerance (du1) by treatment level (4 groups).  
...
In Figure \@ref(fig:Figure8-23), there are some
...
To reinforce what this additive model is doing, Figure \@ref(fig:Figure8-24)
...
(ref:fig8-24) Plot of estimated noise tolerance additive model.
...
\indent The right panel of the term-plot (Figure \@ref(fig:Figure8-25)) shows how the *T3* group
...
(ref:fig8-25) Term-plots of the additive decibel tolerance model with partial residuals. 
...
\indent The diagnostic plots in Figure \@ref(fig:Figure8-26) provides some 
...
(ref:fig8-26) Diagnostic plots for the additive decibel tolerance model. 
...
need to add group information to diagnostics to see if any patterns in residuals look
different in different groups, like linearity or non-constant variance, when we are fitting models that might contain multiple groups. We can use the ``scatterplot`` function to plot the residuals (extracted using the ``residuals`` function) versus the fitted values (extracted using the ``fitted`` function) by groups as in Figure \@ref(fig:Figure8-27). In this example, there are no additional patterns extracted by making this plot, but it is a good additional check in these multi-group situations.


(ref:fig8-27) Plot of residuals versus fitted values by treatment group from the additive decibel tolerance model.
...
<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-27-1.png" alt="(ref:fig8-27)" width="768" />
...
Figure \@ref(fig:Figure8-28) seems to indicate some clear differences in the
...
(ref:fig8-28) Scatterplot for reading score versus nonverbal IQ by dyslexia group. 

<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-28-1.png" alt="(ref:fig8-28)" width="768" />
...
It is a bit hard to see issues in Figure \@ref(fig:Figure8-29) because of the
group differences, 
...
(ref:fig8-29) Diagnostic plots for interaction model for reading scores. 
...
(ref:fig8-30) Plot of Residuals vs Fitted from interaction dyslexia data model with groups indicated.
...
Figure \@ref(fig:Figure8-31) we can see noticeable differences in the slopes 
...
<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-31-1.png" alt="(ref:fig8-31)" width="576" />
<p class="caption">(\#fig:Figure8-31)(ref:fig8-31)</p>
</div>


(ref:fig8-32) Term-plots for interaction model for reading scores with partial residuals and the results for the two groups in different panels of the plot. 
...
and term-plots (Figure \@ref(fig:Figure8-33)) suggest the potentially
dangerous conclusion that
can come from assuming a common slope when that might not be the case. 

\newpage

(ref:fig8-33) Term-plots for additive model for reading scores.
...
students ($t_{41}=1.34$, p-value=0.188), adjust for dyslexia status, but strong evidence against the null hypothesis of no difference in the true
...
(ref:fig8-34) Term-plot for dyslexia status only model for reading scores.
...
These results, including the term-plot in Figure \@ref(fig:Figure8-34), show
...
(ref:fig8-35) Term-plot for decibel tolerance interaction model with partial residuals (version 1). 
...
Or we can let the term-plots (Figures \@ref(fig:Figure8-35) and 
\@ref(fig:Figure8-36)) show us all four different simplified models. Here we
...
\@ref(fig:Figure8-35)) has a
different panel for each level of the categorical variable and Version 2
(Figure \@ref(fig:Figure8-36)) puts all the lines on the same plot. In this
case, neither
...
(ref:fig8-36) Term-plot for decibel tolerance interaction model (version 2). This plot is not printed in color because it is impossible to distinguish the four groups whether in color or black and white.
...
model higher in the tree of models and we can move down the tree by setting a set of slope coefficients to 0) displayed in Figure \@ref(fig:Figure8-37).
This is based on
...
(ref:fig8-37) Diagram of models to consider in an interaction model. 

<div class="figure" style="text-align: center">
<img src="chapter8_files/nestedModelTree_medium.png" alt="(ref:fig8-37)" width="100%" />
...
*Min.Temp*, but the top model did not require its inclusion. It is also possible to think about the AICs as a result on a number line from "closest to the truth" to "farthest" for the suite of models considered, as shown in Figure \@ref(fig:Figure8-38).


(ref:fig8-38) Display of AIC results on a number line with models indicated by their number in the ``dredge`` output. Note that the actual truth is unknown but further left in the plot corresponds to the models that are estimated to be closer to the truth and so there is stronger evidence for those models versus the others.

<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-38-1.png" alt="(ref:fig8-38)" width="768" />
...
\@ref(fig:Figure8-39) shows the suggestion of different slopes for the
...
(ref:fig8-39) Scatterplot of log(FEV) vs Age by smoking status.

<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-39-1.png" alt="(ref:fig8-39)" width="960" />
...
(ref:fig8-40) Diagnostics for the log(FEV) model that includes height, sex, and an interaction between age and smoking status (the full model). 
...
<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-40-1.png" alt="(ref:fig8-40)" width="960" />
<p class="caption">(\#fig:Figure8-40)(ref:fig8-40)</p>
</div>

The diagnostic plots suggest that there are a few outlying points (Figure \@ref(fig:Figure8-40)) but they
...
<div class="figure">
<img src="08-multipleLinearRegression_files/figure-html/Figure8-41-1.png" alt="(ref:fig8-41)" width="960" />
...
term-plots (Figure \@ref(fig:Figure8-42)) we see that in this model there are positive slopes
...
(ref:fig8-42) Term-plots for the top AIC model for log(FEV) that includes height, age, smoking status, and sex in the model.
