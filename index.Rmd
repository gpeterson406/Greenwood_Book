...
date: 'Version 4.1 -- Published Spring 2018'
output:
  bookdown::pdf_book: 
    keep_tex: yes
...
This is Version 4.1 of the book that contains small changes to correct a few small errors and R code changes from version 4.0. Version 4.0 of the text was created by Greta Linse Peterson of Great Lines Writing and Consulting Services (https://www.greatlineswriting.com/) who ported the book into RStudio's bookdown format and tried to edit and improve the writing in the text. Any remaining errors are the responsibility of Mark Greenwood. The first chapters of the book were developed during Fall 2013 and the text has continually evolved since its creation. In Version 4.0, we adopted "tibbles" and updated some of our discussion of hypothesis testing to reflect the newest thinking in the statistics education community. As a field, we are transitioning from fixed alpha, null hypothesis significance testing, to graded interpretations of evidence available from p-values. This update tries to further refine the presentation of interpretations of hypothesis testing results.
...
knitr::write_bib(c(
  ...
  "mosaicData", "effects", "car", "carData", "multcomp", "faraway", "Sleuth2", "vcd",
