...
```{r Figure7-4,fig.cap="(ref:fig7-4)",error=F,message=F,fig.height=5,fig.width=10}
...
```{r Figure7-5,fig.cap="Diagnostic plots of the Bozeman yearly temperature simple linear  regression model.",fig.height=4,fig.width=10}
...
(@R-carData, @Fox2003) in a data set called ``UN``. The four panels in 
...
```{r Figure7-16,fig.cap="(ref:fig7-16)",echo=F,fig.height=5,fig.width=10}
require(carData)
data(UN)
...
```{r Figure7-19,fig.cap="(ref:fig7-19)",fig.height=5,fig.width=10}
par(mfrow=c(2,2))
plot(ID1)
```
...
```{r Figure7-21,fig.cap="(ref:fig7-21)",echo=F,fig.height=5,fig.width=10}
ID2 <- lm(log(infantMortality)~log(ppgdp), data=UN)
summary(ID2)
par(mfrow=c(2,2))
plot(ID2)
