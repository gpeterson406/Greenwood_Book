...
temperature linear regression model with bold vertical lines delineating the 95%
...
(ref:fig7-23) Estimated SLR for BAC data with 95% confidence (darker, dashed lines)
