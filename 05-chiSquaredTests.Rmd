...
\index{independence assumption!X-squared test}
...
are calculated as \index{Chi-squared test} 
...
(ref:fig5-14) Tableplot of election data with subjects without any missing responses.
