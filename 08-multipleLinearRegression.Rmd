...
scatterplot(FYGPA~SATV|SEX, lwd=3, data=satGPA, smooth=list(spread=F),
...
scatterplot(FYGPA~SATM|SEX, lwd=3, data=satGPA, smooth=list(spread=F),
...
* **plot(allEffects(`r colFmt("MODELNAME","red")`))**
    ...
    * Provides a plot of the estimated regression lines with 95% confidence
    ...
    \index{\texttt{plot(allEffects())}|textbf}
