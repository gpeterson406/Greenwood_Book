...
These results, including the term-plot in Figure \@ref(fig:Figure8-34), suggest a difference in the mean reading scores
...
{\centering \includegraphics[width=1\linewidth]{chapter8_files/nestedModelTree_medium} 
