...
\begin{figure}[ht]
\includegraphics[width=38.01in]{chapter1_files/fig1.4} \caption{(ref:fig1-4)}(\#fig:Figure1-4)
\end{figure}
...
\begin{figure}[ht]
\includegraphics[width=26.67in]{chapter1_files/image010} \caption{(ref:fig1-6)}(\#fig:Figure1-6)
\end{figure}
