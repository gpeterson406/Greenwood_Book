...
```{r Figure9-9,fig.cap="(ref:fig9-9)", fig.height=4}
...
did provide a plot very similar to Figure \@ref(fig:Figure9-13). To make Figure \@ref(fig:Figure9-13) ``geom_line`` \index{\texttt{geom\_line}} is used to display a 
...
epworthdata %>% 
  ggplot(mapping = aes(x = Time, y = SimEpworth, group = Subject, colour = Group)) +
  geom_point() +
  geom_line() + theme_bw() + 
  scale_color_colorblind() +
