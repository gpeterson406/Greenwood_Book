...
```{r Figure4-3b, fig.cap="(ref:fig4-3b)",fig.height=5,fig.width=10}
...
2. **Validity conditions:**
    ...
    * Constant variance:
        ...
        * In the Residuals vs Fitted and the Scale-Location plots, the 
        ...
        ```{r Figure4-9,fig.cap="Diagnostic plots for the interaction model for odontoblast         growth interaction model.",fig.height=5,fig.width=10}
        par(mfrow=c(2,2))
        plot(TG2, pch=16) 
        ```
...
2. **Validity conditions -- discussed above but with new plots for the additive model:**
    ...
    ```{r Figure4-14,fig.cap="Diagnostic plot for ``prodebt`` by income group and buy   cigarettes/not",fig.height=5,fig.width=10}
