...
* **ggplot(data = **`r colFmt("DATASETNAME","red")`**, mapping = aes(**`r colFmt("VARIABLENAME","red")`**)) + geom_histogram(bins = **`r colFmt("10","red")`**)**
    ...
    * Makes a histogram with 10 bins using `ggplot`, requires the `ggplot2` library is installed and loaded. \index{\texttt{geom\_histogram()}|textbf}
