...
```{r Figure8-11,fig.cap="(ref:fig8-11)",fig.height=6,fig.width=8}
set.seed(307)
...
```{r Figure8-15,fig.cap="(ref:fig8-15)",fig.height=5,fig.width=7}
library(openintro)
data(satGPA)
...
par(mfrow=c(1,1))
plot(dm1$SATM,fitmales,ylim=c(min(fitmales),max(fitfemales)),main="Plot of estimated regression lines by sex",type="l",lwd=2,xlab="SATM",ylab="FYGPA", col=viridis(8)[7])
...
plot(du1s,predict(head1,newdata=hdcontrol),lwd=2,lty=2,ylim=c(0,16),type="l",xlab="DU1",ylab="DU2",main="Plot of additive estimated regression model", col=viridis(4)[1])
...
```{r Figure8-28,fig.cap="(ref:fig8-28)",echo=F}
library(smdata)
data("dyslexic3")
...
```{r Figure8-37,fig.cap="(ref:fig8-37)",echo=F,warning=F,message=F}
...
```{r Figure8-41,fig.cap="(ref:fig8-41)",echo=F, fig.height=6, fig.width=8,echo=F,warning=F,message=F}
...
```{r Figure8-42,fig.cap="(ref:fig8-42)",fig.height=4.5,fig.width=7}
fm1R$coefficients
vif(fm1R)
confint(fm1R)
